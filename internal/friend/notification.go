...
func (f *Friend) doNotification(ctx context.Context, msg *sdkws.MsgData) error {
	...
	case constant.FriendApplicationNotification: //好友请求增加
		tips := sdkws.FriendApplicationTips{}
		if err := utils.UnmarshalNotificationElem(msg.Content, &tips); err != nil {
			return err
		}
		return f.syncApplication(ctx, tips.FromToUserID)
	case constant.FriendApplicationApprovedNotification: //发起的好友请求被同意
		...
		return f.syncApplication(ctx, tips.FromToUserID)
	case constant.FriendApplicationRejectedNotification: //发起的好友请求被拒绝
		var tips sdkws.FriendApplicationRejectedTips
		if err := utils.UnmarshalNotificationElem(msg.Content, &tips); err != nil {
			return err
		}
		return f.syncApplication(ctx, tips.FromToUserID)
	case constant.FriendAddedNotification: //新增好友通知
		return f.SyncFriendList(ctx)
	case constant.FriendDeletedNotification: //好友被删除通知
		...
		return nil
	case constant.FriendRemarkSetNotification: // 好友给设置备注
		...
		return nil
	case constant.FriendInfoUpdatedNotification: //好友信息变更
		return f.SyncFriendList(ctx)
	case constant.BlackAddedNotification: //被好友啦黑
		...
		return nil
	case constant.BlackDeletedNotification: //被好友移出黑名单
